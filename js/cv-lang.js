...
(function () {
  ...
  var CV_UI_DICT = {
    en: {
      ...
      downloadTitle:'Your CV is ready!', downloadSubtitle:'Download your CV as a high-quality PDF.',
      downloadPDF:'Download PDF', copyText:'Copy text', newCV:'New CV',
      ctaLabel:'✉️ Recommended next step',
      ctaText:'80% of recruiters expect a cover letter. Create yours free in 3 minutes.',
      ctaButton:'✉️ Create my cover letter →',
      chipA4:'📄 A4 Format', chipPrint:'🖨️ Print-ready', chipATS:'🤖 ATS-compatible', chipPrivate:'🔒 100% private',
      chooseTemplateSubtitle:'Select the design that best suits your industry.',
      tplClassicName:'Classic', tplClassicDesc:'Timeless & versatile',
      tplModernName:'Modern', tplModernDesc:'Dynamic & colourful',
      tplMinimalName:'Minimal', tplMinimalDesc:'Clean & elegant',
      tplExecutiveName:'Executive', tplExecutiveDesc:'Senior & prestigious',
      tplElegantName:'Elegant', tplElegantDesc:'Luxurious & refined',
      tplBoldName:'Bold', tplBoldDesc:'Daring & impactful'
    },
    fr: {
      ...
      downloadTitle:'Votre CV est prêt !', downloadSubtitle:'Téléchargez votre CV en PDF de haute qualité.',
      downloadPDF:'Télécharger le PDF', copyText:'Copier le texte', newCV:'Nouveau CV',
      ctaLabel:'✉️ Prochaine étape recommandée',
      ctaText:'80 % des recruteurs attendent une lettre de motivation. Créez la vôtre gratuitement en 3 minutes.',
      ctaButton:'✉️ Créer ma lettre de motivation →',
      chipA4:'📄 Format A4', chipPrint:'🖨️ Prêt à imprimer', chipATS:'🤖 Compatible ATS', chipPrivate:'🔒 100 % privé',
      chooseTemplateSubtitle:'Sélectionnez le design qui correspond le mieux à votre secteur.',
      tplClassicName:'Classique', tplClassicDesc:'Intemporel & polyvalent',
      tplModernName:'Moderne', tplModernDesc:'Dynamique & coloré',
      tplMinimalName:'Minimaliste', tplMinimalDesc:'Épuré & élégant',
      tplExecutiveName:'Exécutif', tplExecutiveDesc:'Senior & prestige',
      tplElegantName:'Élégant', tplElegantDesc:'Luxueux & raffiné',
      tplBoldName:'Audacieux', tplBoldDesc:'Impactant & moderne'
    },
    nl: {
      ...
      downloadTitle:'Uw CV is klaar!', downloadSubtitle:'Download uw CV als hoogwaardig PDF.',
      downloadPDF:'PDF downloaden', copyText:'Tekst kopiëren', newCV:'Nieuw CV',
      ctaLabel:'✉️ Aanbevolen volgende stap',
      ctaText:'80% van de recruiters verwacht een sollicitatiebrief. Maak de uwe gratis in 3 minuten.',
      ctaButton:'✉️ Mijn sollicitatiebrief maken →',
      chipA4:'📄 A4-formaat', chipPrint:'🖨️ Afdrukklaar', chipATS:'🤖 ATS-compatibel', chipPrivate:'🔒 100% privé',
      chooseTemplateSubtitle:'Kies het ontwerp dat het beste past bij uw sector.',
      tplClassicName:'Klassiek', tplClassicDesc:'Tijdloos & veelzijdig',
      tplModernName:'Modern', tplModernDesc:'Dynamisch & kleurrijk',
      tplMinimalName:'Minimaal', tplMinimalDesc:'Strak & elegant',
      tplExecutiveName:'Directeur', tplExecutiveDesc:'Senior & prestige',
      tplElegantName:'Elegant', tplElegantDesc:'Luxueus & verfijnd',
      tplBoldName:'Gedurfd', tplBoldDesc:'Stoutmoedig & impactvol'
    },
    es: {
      ...
      downloadTitle:'¡Su CV está listo!', downloadSubtitle:'Descargue su CV en PDF de alta calidad.',
      downloadPDF:'Descargar PDF', copyText:'Copiar texto', newCV:'Nuevo CV',
      ctaLabel:'✉️ Próximo paso recomendado',
      ctaText:'El 80% de los reclutadores esperan una carta de presentación. Crea la tuya gratis en 3 minutos.',
      ctaButton:'✉️ Crear mi carta de presentación →',
      chipA4:'📄 Formato A4', chipPrint:'🖨️ Listo para imprimir', chipATS:'🤖 Compatible ATS', chipPrivate:'🔒 100% privado',
      chooseTemplateSubtitle:'Seleccione el diseño que mejor se adapte a su sector.',
      tplClassicName:'Clásico', tplClassicDesc:'Atemporal & versátil',
      tplModernName:'Moderno', tplModernDesc:'Dinámico & colorido',
      tplMinimalName:'Minimalista', tplMinimalDesc:'Limpio & elegante',
      tplExecutiveName:'Ejecutivo', tplExecutiveDesc:'Senior & prestigioso',
      tplElegantName:'Elegante', tplElegantDesc:'Lujoso & refinado',
      tplBoldName:'Atrevido', tplBoldDesc:'Audaz & impactante'
    },
    ar: {
      ...
      downloadTitle:'سيرتك الذاتية جاهزة!', downloadSubtitle:'قم بتنزيل سيرتك الذاتية بصيغة PDF عالية الجودة.',
      downloadPDF:'تنزيل PDF', copyText:'نسخ النص', newCV:'سيرة ذاتية جديدة',
      ctaLabel:'✉️ الخطوة التالية الموصى بها',
      ctaText:'80% من المسؤولين عن التوظيف يتوقعون رسالة تغطية. أنشئ رسالتك مجانًا في 3 دقائق.',
      ctaButton:'✉️ إنشاء رسالة التغطية →',
      chipA4:'📄 تنسيق A4', chipPrint:'🖨️ جاهز للطباعة', chipATS:'🤖 متوافق مع ATS', chipPrivate:'🔒 خصوصية 100%',
      chooseTemplateSubtitle:'اختر التصميم الأنسب لقطاعك المهني.',
      tplClassicName:'كلاسيكي', tplClassicDesc:'راسخ ومتعدد الاستخدامات',
      tplModernName:'عصري', tplModernDesc:'ديناميكي وملوّن',
      tplMinimalName:'بسيط', tplMinimalDesc:'نظيف وأنيق',
      tplExecutiveName:'تنفيذي', tplExecutiveDesc:'احترافي ومرموق',
      tplElegantName:'أنيق', tplElegantDesc:'فاخر وراقٍ',
      tplBoldName:'جريء', tplBoldDesc:'جذاب ومؤثر'
    },
    ru: {
      ...
      downloadTitle:'Ваше резюме готово!', downloadSubtitle:'Скачайте резюме в формате PDF высокого качества.',
      downloadPDF:'Скачать PDF', copyText:'Копировать текст', newCV:'Новое резюме',
      ctaLabel:'✉️ Рекомендуемый следующий шаг',
      ctaText:'80% рекрутеров ожидают сопроводительное письмо. Создайте своё бесплатно за 3 минуты.',
      ctaButton:'✉️ Создать моё письмо →',
      chipA4:'📄 Формат A4', chipPrint:'🖨️ Готово к печати', chipATS:'🤖 Совместимо с ATS', chipPrivate:'🔒 100% конфиденциально',
      chooseTemplateSubtitle:'Выберите дизайн, подходящий для вашей отрасли.',
      tplClassicName:'Классический', tplClassicDesc:'Вне времени & универсальный',
      tplModernName:'Современный', tplModernDesc:'Динамичный & красочный',
      tplMinimalName:'Минималистичный', tplMinimalDesc:'Чистый & элегантный',
      tplExecutiveName:'Представительский', tplExecutiveDesc:'Руководящий & престижный',
      tplElegantName:'Элегантный', tplElegantDesc:'Роскошный & изысканный',
      tplBoldName:'Смелый', tplBoldDesc:'Дерзкий & впечатляющий'
    },
    de: {
      ...
      downloadTitle:'Ihr Lebenslauf ist fertig!', downloadSubtitle:'Laden Sie Ihren Lebenslauf als hochwertiges PDF herunter.',
      downloadPDF:'PDF herunterladen', copyText:'Text kopieren', newCV:'Neuer Lebenslauf',
      ctaLabel:'✉️ Empfohlener nächster Schritt',
      ctaText:'80 % der Recruiter erwarten ein Anschreiben. Erstellen Sie Ihres kostenlos in 3 Minuten.',
      ctaButton:'✉️ Mein Anschreiben erstellen →',
      chipA4:'📄 A4-Format', chipPrint:'🖨️ Druckfertig', chipATS:'🤖 ATS-kompatibel', chipPrivate:'🔒 100% privat',
      chooseTemplateSubtitle:'Wählen Sie das Design, das am besten zu Ihrer Branche passt.',
      tplClassicName:'Klassisch', tplClassicDesc:'Zeitlos & vielseitig',
      tplModernName:'Modern', tplModernDesc:'Dynamisch & farbenfroh',
      tplMinimalName:'Minimal', tplMinimalDesc:'Klar & elegant',
      tplExecutiveName:'Führungskraft', tplExecutiveDesc:'Senior & prestige',
      tplElegantName:'Elegant', tplElegantDesc:'Luxuriös & raffiniert',
      tplBoldName:'Kühn', tplBoldDesc:'Gewagt & wirkungsvoll'
    },
    pt: {
      ...
      downloadTitle:'O seu CV está pronto!', downloadSubtitle:'Transfira o seu CV em PDF de alta qualidade.',
      downloadPDF:'Transferir PDF', copyText:'Copiar texto', newCV:'Novo CV',
      ctaLabel:'✉️ Próximo passo recomendado',
      ctaText:'80% dos recrutadores esperam uma carta de apresentação. Crie a sua gratuitamente em 3 minutos.',
      ctaButton:'✉️ Criar a minha carta →',
      chipA4:'📄 Formato A4', chipPrint:'🖨️ Pronto para imprimir', chipATS:'🤖 Compatível ATS', chipPrivate:'🔒 100% privado',
      chooseTemplateSubtitle:'Selecione o design que melhor se adapta ao seu sector.',
      tplClassicName:'Clássico', tplClassicDesc:'Intemporal & versátil',
      tplModernName:'Moderno', tplModernDesc:'Dinâmico & colorido',
      tplMinimalName:'Minimalista', tplMinimalDesc:'Limpo & elegante',
      tplExecutiveName:'Executivo', tplExecutiveDesc:'Sénior & prestígio',
      tplElegantName:'Elegante', tplElegantDesc:'Luxuoso & refinado',
      tplBoldName:'Ousado', tplBoldDesc:'Audacioso & impactante'
    }
  };
